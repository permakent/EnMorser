...
class MorseKeyboard(tk.Tk):
    ...
    def create_display_area(self):
        ...
        txt_title = tk.Label(display_frame, width=50, font=('arial', 12),
                    text = "EnMorser Terminal", fg='#003300')
        txt_title.grid(row=0, column=0, columnspan=10, padx=2, pady=2, sticky="w")
